...
/* Line 1455 of yacc.c  */
#line 90 "Cool_code.y"
    { (yyval.feature) = make_method((yyvsp[(1) - (10)].str), (yyvsp[(3) - (10)].formal_list), (yyvsp[(6) - (10)].str), make_block((yyvsp[(8) - (10)].expr_list))); ;}
    break;
...
#line 131 "Cool_code.y"
    { (yyval.expr) = make_block((yyvsp[(2) - (3)].expr_list)); ;}
    break;
...
#line 137 "Cool_code.y"
    { (yyval.let_list) = append_let_list((yyvsp[(1) - (5)].let_list), make_let_binding((yyvsp[(3) - (5)].str), (yyvsp[(5) - (5)].str), NULL)); ;}
    break;
...
#line 138 "Cool_code.y"
    { (yyval.let_list) = append_let_list((yyvsp[(1) - (7)].let_list), make_let_binding((yyvsp[(3) - (7)].str), (yyvsp[(5) - (7)].str), (yyvsp[(7) - (7)].expr))); ;}
    break;
...
#line 151 "Cool_code.y"
    { (yyval.expr_list) = append_expr_list((yyvsp[(1) - (3)].expr_list), (yyvsp[(2) - (3)].expr)); ;}
    break;
...
#line 152 "Cool_code.y"
    { (yyval.expr_list) = make_expr_list((yyvsp[(1) - (2)].expr)); ;}
    break;
